...
def ljspeech(metadata_path: str, column_sep='|') -> dict:  # change this name to match the language
    text_dict = {}
...
if __name__ == '__main__':
    metadata_path = '/Volumes/data/datasets/LJSpeech-1.1/metadata.csv' # change this path to match the metadata file path
    d = get_preprocessor_by_name('ljspeech')(metadata_path) # change this name to match the language
